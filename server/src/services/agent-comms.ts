...
//
// Enables the 3 core agents (Weebo, Edith, Jarvis) to
// communicate with each other. Messages are stored in DB,
// broadcast via agent-state-bus SSE, and visible in the
// Agent Office activity feed.
// ============================================================
