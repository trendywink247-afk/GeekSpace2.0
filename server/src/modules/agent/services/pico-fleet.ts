...
import { refreshModelsIfStale } from '../../../services/openrouter-models.js';
  ...
  try {
    ...
    switch (task.task_type) {
      ...
      case 'social_media_post': {
        const { executeSocialMediaPostTask } = await import('../../../services/social-media.js');
...
async function checkDailySummarization(): Promise<void> {
  ...
  try {
    const { summarizeUserDay } = await import('../../../services/memory-summarizer.js');
...
async function checkAndRunRecipes(): Promise<void> {
  try {
    const { executeRecipe } = await import('../../../services/recipes.js');
...
async function tick() {
  ...
  try {
    ...
    try {
      const { checkDueSocialPosts } = await import('../../../services/social-media.js');
