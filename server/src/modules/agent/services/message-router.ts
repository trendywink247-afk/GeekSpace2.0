...
import { logConversation, logTrainingExample, extractMemories, extractMemoriesWithOllama, getConversationContext, upsertMemory } from '../../../services/memory.js';
...
// ── Extracted modules ──
import { buildChannelSystemPrompt, buildActionChannelSuffix } from './prompt-builder.js';
import { resolveUserFromChannel, sendChannelResponse, sendUnlinkedResponse } from './channel-dispatcher.js';

// Re-export for backward compat
export { buildPersonalityInstructions, mapCreativityToTemperature, TOOL_INSTRUCTIONS } from './prompt-builder.js';
export { buildChannelSystemPrompt, buildActionChannelSuffix };
export { sendChannelResponse, resolveUserFromChannel };
export type { ChannelResponse, ResolvedUser } from './channel-dispatcher.js';
...
export async function handleIncomingMessage(msg: NormalizedMessage): Promise<void> {
  ...
  if (!resolved) {
    ...
    await sendUnlinkedResponse(msg.channel, msg.externalId);
    return;
  }
