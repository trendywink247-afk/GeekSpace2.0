...
describe("Phase 75 — Production Hardening + E2E", () => {
	...
	it("DashboardRouter uses lazyRetry instead of bare lazy", () => {
		const content = readFileSync(
			resolve(ROOT, "src/dashboard/DashboardRouter.tsx"),
			"utf-8",
		);
