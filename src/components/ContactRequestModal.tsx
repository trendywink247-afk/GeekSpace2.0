...
export function ContactRequestModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#0A0A0F] border border-[#00FFD4]/20 rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-[#00FFD4]/10">
          <h3 className="text-lg font-semibold text-[#E8E8F0]">
            Contact {toUserName}
          </h3>
          <button
            onClick={onClose}
            className="p-2 rounded-lg text-[#6B7280] hover:text-white hover:bg-[#00FFD4]/10 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 space-y-4">
          {step === 'form' && (
            <>
              {/* Info banner */}
              <div className="p-3 rounded-xl bg-[#00FFD4]/10 border border-[#00FFD4]/20">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-[#030304] border border-[#00FFD4]/20 text-[#E8E8F0] placeholder-[#6B7280] focus:outline-none focus:border-[#00FFD4]/40 resize-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2.5 rounded-lg bg-[#030304] border border-[#00FFD4]/20 text-[#E8E8F0] placeholder-[#6B7280] focus:outline-none focus:border-[#00FFD4]/40 resize-none"
                />
              </div>
          ...
          {step === 'submitting' && (
            <div className="py-12 text-center">
              <Loader2 className="w-12 h-12 text-[#00FFD4] animate-spin mx-auto mb-4" />
          ...
          {step === 'waiting' && (
            <div className="py-8 text-center">
              ...
              <div className="p-3 rounded-lg bg-[#030304] text-left">
                <p className="text-xs text-[#6B7280] mb-1">Request ID</p>
                <p className="text-sm text-[#E8E8F0] font-mono">{requestId}</p>
              </div>
              <Button onClick={onClose} className="mt-6 bg-[#00FFD4] hover:bg-[#00D4B0]">
                Got it
              </Button>
            </div>
          )}
          ...
          {step === 'error' && (
            <div className="py-8 text-center">
              ...
              <Button onClick={() => setStep('form')} variant="outline" className="border-[#00FFD4]/30">
                Try Again
              </Button>
            </div>
          )}
        ...
        {/* Footer */}
        {step === 'form' && (
          <div className="flex gap-3 p-4 border-t border-[#00FFD4]/10">
            <Button
              variant="outline"
              onClick={onClose}
              className="flex-1 border-[#00FFD4]/30 text-[#6B7280]"
            >
              Cancel
            </Button>
            <Button
              ...
              className="flex-1 bg-[#00FFD4] hover:bg-[#00D4B0] disabled:opacity-50"
            >
