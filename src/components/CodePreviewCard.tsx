...
export function CodePreviewCard({ artifactId, title, html, css, js }: CodePreviewCardProps) {
  ...
  return (
    <div
      ...
      className="border border-[#8B5CF6]/30 bg-[#06060B] rounded-xl overflow-hidden"
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#8B5CF6]/20">
        <div className="flex items-center gap-2 min-w-0">
          <Code className="size-4 shrink-0 text-[#8B5CF6]" />
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Button
            ...
            className="text-[#6B7280] hover:text-[#E8E8F0] hover:bg-[#8B5CF6]/10"
          >
            {showPreview ? (
