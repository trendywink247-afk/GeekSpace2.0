    ...
    >
      ...
      >
        <div className="text-center">
          <div className="w-14 h-14 rounded-full bg-[#A78BFA]/10 border border-[#A78BFA]/20 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button
            onClick={onStay}
            autoFocus
            className="w-full bg-[#A78BFA]/10 hover:bg-[#A78BFA]/20 text-[var(--ag-cyan)] border border-[#A78BFA]/20"
          >
            Stay signed in
          </Button>
        </div>
