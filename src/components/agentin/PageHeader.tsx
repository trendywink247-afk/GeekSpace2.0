        ...
        <div className="min-w-0">
          <BlurFade delay={0.05}>
            <div className="flex items-center gap-2.5">
              <h1 className="text-2xl md:text-3xl font-bold text-[var(--ag-text-primary,#F4F6FF)] font-heading truncate">
                {title}
              </h1>
              {badge}
            </div>
          ...
          {subtitle && (
            <BlurFade delay={0.1}>
              <p className="text-sm text-[var(--ag-text-secondary,#8892A4)] mt-0.5 truncate">{subtitle}</p>
            </BlurFade>
          )}
        </div>
      </div>
