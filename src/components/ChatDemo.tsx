      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6">
        ...
        <motion.div initial={reduced ? undefined : { opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ delay: 0.15, duration: 0.7, ease: ease4 }}
          ...
          <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/[0.06]">
            ...
            <span className="flex-1 text-center text-xs text-[#8892A4] font-medium flex items-center justify-center gap-1.5"><Bot className="w-3.5 h-3.5 text-[#8B5CF6]" /> Chat with Agentin</span>
          </div>
