    ...
    >
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          <Terminal size={14} className="text-[#A78BFA] shrink-0" />
          <span className="text-xs font-medium text-[#A78BFA] font-['Space_Grotesk']">Terminal</span>
      ...
      >
        <span className="text-[#A78BFA] font-['JetBrains_Mono'] text-sm shrink-0 select-none">$</span>
        <input
          type="text"
          value={inputValue}
          ...
          autoCapitalize="off"
          spellCheck={false}
          className="flex-1 min-w-0 h-11 bg-transparent text-sm font-['JetBrains_Mono'] text-foreground placeholder:text-muted-foreground/50 outline-none caret-[#A78BFA]"
        />
        <button
          type="submit"
          className="shrink-0 flex items-center justify-center w-11 h-11 rounded-xl bg-[rgba(139,92,246,0.12)] active:bg-[rgba(139,92,246,0.22)] text-[#A78BFA]"
