    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-2">
          {TAG_OPTIONS.map((tag) => (
            <button
              ...
              className={`px-4 py-2 min-h-[44px] rounded-full text-sm transition-all focus-visible:ring-2 focus-visible:ring-[#8B5CF6]/50 ${
                tags.includes(tag)
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full p-3 rounded-xl bg-[#06060B] border border-[#8B5CF6]/30 text-[#E8E8F0] text-base min-h-[100px] resize-none focus:outline-none focus:border-[#8B5CF6] focus-visible:ring-2 focus-visible:ring-[#8B5CF6]/50 placeholder:text-[#6B7280]/50"
        />
