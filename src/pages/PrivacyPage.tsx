      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10">
          ...
          <Section icon={Database} title="1. Data We Collect">
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Account Information</h3>
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Google User Data</h3>
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Conversation Data</h3>
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Usage Data</h3>
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">User-Created Content</h3>
          ...
          <Section icon={Eye} title="2. How We Use Your Data">
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">What We Do NOT Do With Your Data</h3>
            <ul className="list-disc ml-5 mt-1 space-y-1">
          ...
          <Section icon={Server} title="3. Data Storage &amp; Security">
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Where We Store Data</h3>
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">How We Protect Data</h3>
            <ul className="list-disc ml-5 mt-1 space-y-1">
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Data Retention</h3>
            <ul className="list-disc ml-5 mt-1 space-y-1">
          ...
          <Section icon={Globe} title="4. Google User Data — Specific Disclosures">
            ...
            className="text-[#00F0FF] hover:underline" target="_blank" rel="noopener noreferrer">
            Google API Services User Data Policy</a>.</p>

            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Scopes We Request</h3>
            <table className="w-full mt-2 text-sm">
              ...
              <tbody className="text-[#9CA3AF]">
                <tr className="border-b border-[#00F0FF]/5">
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">How Google Data Is Used</h3>
            <ul className="list-disc ml-5 mt-1 space-y-1">
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">How Google Data Is Stored</h3>
            <ul className="list-disc ml-5 mt-1 space-y-1">
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">How Google Data Is Shared</h3>
            <ul className="list-disc ml-5 mt-1 space-y-1">
            ...
            <h3 className="font-medium text-[#E8E8F0] mt-3 mb-1">Revoking Access</h3>
            <p>You can disconnect Google services at any time from your Agentin Settings page. You can also
            revoke access from your <a href="https://myaccount.google.com/permissions" className="text-[#00F0FF]
            hover:underline" target="_blank" rel="noopener noreferrer">Google Account permissions page</a>.
        ...
        <div className="mt-12 p-6 rounded-xl bg-[#0C0C18] border border-[#00F0FF]/20">
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-3">
        ...
        <h2 className="text-xl font-semibold text-[#E8E8F0]">{title}</h2>
      </div>
