        ...
        <SectionCard padding="lg">
            {stage === 'loading' && (
              <div className="text-center py-8">
                <Loader2 className="w-8 h-8 text-[var(--ag-cyan,#A78BFA)] animate-spin mx-auto mb-4" />
            ...
            {stage === 'error' && (
              <div className="text-center py-8">
                ...
                <Link to="/">
                  <Button variant="outline" className="min-h-[44px] border-[var(--ag-border-subtle,rgba(139,92,246,0.15))] text-[var(--ag-cyan,#A78BFA)] hover:border-[var(--ag-border-default,rgba(139,92,246,0.25))] focus-visible:ring-2 focus-visible:ring-[var(--ag-cyan,#A78BFA)]/50">
                    Go to Homepage
                  </Button>
                </Link>
              </div>
            ...
            {stage === 'success' && (
              <div className="text-center py-8">
                ...
                <p className="text-[var(--ag-text-muted,#9CA3AF)] mb-2">
                  You are now connected with <span className="text-[var(--ag-cyan,#A78BFA)] font-medium">{invite?.ownerName}</span>.
                </p>
                ...
                <Link to="/login?signup=1">
                  <Button className="min-h-[44px] bg-[var(--ag-cyan,#A78BFA)] hover:bg-[#00D4B0] text-[#06061a] font-semibold focus-visible:ring-2 focus-visible:ring-[var(--ag-cyan,#A78BFA)]/50">
              ...
              <>
                ...
                <div className="text-center mb-6">
                  {invite.ownerAvatar ? (
                    ...
                    <div className="w-16 h-16 rounded-full mx-auto mb-3 bg-[var(--ag-cyan,#A78BFA)]/20 flex items-center justify-center text-2xl font-bold text-[var(--ag-cyan,#A78BFA)]">
                  ...
                  <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--ag-cyan,#A78BFA)]/10 border border-[var(--ag-border-subtle,rgba(139,92,246,0.08))]">
                    <UserPlus className="w-4 h-4 text-[var(--ag-cyan,#A78BFA)]" />
                    <span className="text-sm text-[var(--ag-cyan,#A78BFA)]">Invited you to connect</span>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full min-h-[44px] bg-[var(--ag-cyan,#A78BFA)] hover:bg-[#00D4B0] text-[#06061a] font-semibold focus-visible:ring-2 focus-visible:ring-[var(--ag-cyan,#A78BFA)]/50"
                  >
                    {stage === 'submitting' ? (
                      <>
