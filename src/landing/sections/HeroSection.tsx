...
export function HeroSection({ onEnterDashboard }: HeroSectionProps) {
	...
	return (
		<section
			ref={sectionRef}
			id="hero"
			className="relative min-h-[85dvh] flex flex-col items-center overflow-hidden scanlines w-full"
			style={{ backgroundColor: "var(--lp-bg, #06061a)" }}
		>
			{/* Keyframes */}
			<style>{`
      ...
      `}</style>
        ...
        `,
			...
			<div
				...
				style={{
					backgroundImage:
						"radial-gradient(var(--dot-grid-dot-color, rgba(255,255,255,0.07)) 1px, transparent 1px)",
			...
			<div
				className={`absolute left-1/2 top-[30%] -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] md:w-[700px] md:h-[700px] bg-[#8B5CF6]/[0.025] blur-[140px] rounded-full pointer-events-none transition-opacity duration-1000 delay-200 ${isLoaded ? "opacity-100" : "opacity-0"}`}
			/>
				...
				<BlurFade delay={0.3} inView={isLoaded}>
					<div className="min-h-[1.5em] mb-8 w-full px-4 text-center overflow-visible">
						...
						>
							{typedText}
							<span
								className="inline-block w-[2px] h-[1.1em] bg-[#8B5CF6] align-middle ml-0.5"
								style={{
					...
					<div className="mx-auto max-w-4xl mb-10">
						...
						>
							<div className="flex flex-col md:flex-row">
								...
								<div
									className="flex-1 p-5 md:p-6 border-b md:border-b-0 md:border-r"
								...
								>
									...
									<div className="space-y-3">
										...
										<div className="flex flex-col items-end">
											<span
												className="font-mono text-[10px] mb-1 mr-1"
											...
											<div className="bg-[#8B5CF6]/20 rounded-2xl rounded-tr-md px-4 py-2.5 max-w-[90%] text-left">
												...
												>
													Schedule a meeting with Rahul at 3 PM and draft a
													follow-up email
												</p>
											</div>
										</div>
										...
										<div className="flex flex-col items-start">
											...
											<div
												className="rounded-2xl rounded-tl-md px-4 py-2.5 max-w-[90%] text-left"
											...
											>
												...
												>
													On it! I'll coordinate with Cal for scheduling and
													Aria for the email draft.
												</p>
											</div>
										</div>
											...
											{[0, 1, 2].map((i) => (
												<div
													...
													style={{ background: "var(--border-hover)",
														animation: reducedMotion
															? "none"
															: `typing-bounce 1.4s ease-in-out ${i * 0.16}s infinite`,
													}}
												/>
											))}
										</div>
												...
												<div className="flex items-center gap-1.5 mb-1.5">
													{agent.done ? (
														...
														<div
															...
															style={{
																backgroundColor: agent.amber
																	? "#F59E0B"
																	: "#10B981",
																animation:
																	agent.pulse && !reducedMotion
																		? "pulse-dot 2s ease-in-out infinite"
																		: "none",
															}}
														/>
					...
					<div className="mt-10 flex items-center justify-center gap-3">
						{agents.map((agent, i) => (
							...
							>
								<div
									title={agent.name}
									className="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-[#06060B] ring-2 transition-transform duration-300 group-hover:scale-110"
						...
						<div className="flex flex-col items-center gap-1.5">
							<div
								className="w-10 h-10 rounded-full flex items-center justify-center text-xs font-mono border border-dashed"
								style={{
			...
			<div
				className="absolute bottom-0 left-0 right-0 h-32 pointer-events-none safe-area-pb"
				style={{
					background:
						"linear-gradient(to top, var(--lp-bg, #06061a), transparent)",
				}}
			/>
		</section>
	);
