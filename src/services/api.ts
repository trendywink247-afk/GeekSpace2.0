...
export const suggestionService = {
  ...
  mine: () => api.get<Array<{ id: string; title: string; body: string; status: string; created_at: string }>>('/suggestions/mine'),
  ...
  rewards: () => api.get<Array<{ id: string; eventType: string; credits: number; suggestionId: string | null; clusterId: string | null; createdAt: string }>>('/suggestions/rewards/mine'),
};
