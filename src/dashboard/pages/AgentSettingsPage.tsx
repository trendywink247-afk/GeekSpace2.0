        ...
        <TabsContent value="personality" className="mt-6 space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <SectionCard title="Agent Name" subtitle="This name is used in conversations and greetings." padding="lg">
            <Input
              ...
              className="bg-white/[0.03] border border-white/[0.08] rounded-xl min-h-[44px] text-[var(--ag-text-primary)] max-w-md focus:border-[var(--ag-violet)]/40 focus:ring-[#8B5CF6]/20"
          ...
          <SectionCard padding="lg">
            <div className="mb-4">
              ...
              <p className="text-xs text-[var(--ag-text-secondary)] mt-0.5">Choose the LLM that powers your agent's responses.</p>
            </div>
            <div className="flex flex-wrap gap-2">
              {MODELS.map((m) => {
          ...
          <SectionCard padding="lg">
            <div className="mb-4">
              ...
              <p className="text-xs text-[var(--ag-text-secondary)] mt-0.5">Your agent will respond primarily in this language.</p>
            </div>
            <div className="flex flex-wrap gap-2">
              {[
          ...
          <SectionCard padding="lg">
            <div className="mb-4">
              ...
              <p className="text-xs text-[var(--ag-text-secondary)] mt-0.5">These instructions guide your agent's behavior across all conversations.</p>
            </div>
            <div className="relative">
              <Textarea
              ...
              <span className={`absolute bottom-3 right-3 text-xs font-mono ${
                instructionsLength > 450 ? 'text-[#FF2D78]' : 'text-[var(--ag-text-secondary)]'
              }`}>
          ...
          <SectionCard padding="lg">
            <div className="mb-4">
              <h2 className="text-base font-semibold text-[var(--ag-text-primary)] flex items-center gap-2">
                <Shield className="w-5 h-5 text-[var(--ag-cyan)]" />
                Autonomy Level
              </h2>
              <p className="text-xs text-[var(--ag-text-secondary)] mt-0.5">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-[var(--ag-text-secondary)] mt-1">{level.description}</p>
                    </div>
                  </button>
                );
              })}
          ...
          <SectionCard padding="lg">
            <div className="mb-4">
              <h2 className="text-base font-semibold text-[var(--ag-text-primary)] flex items-center gap-2">
                <Users className="w-5 h-5 text-[var(--ag-cyan)]" />
                Agent Assignments
              </h2>
              <p className="text-xs text-[var(--ag-text-secondary)] mt-0.5">
                ...
                return (
                  <div key={a.id} className="flex items-center justify-between p-3 min-h-[44px] rounded-xl border border-[rgba(139,92,246,0.08)]">
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-sm font-medium text-[var(--ag-text-primary)]">{a.name}</span>
                    </div>
                    <div className="flex flex-wrap gap-1.5">
                      {features.map((f) => (
                        <span key={f} className="text-xs px-2.5 py-1 rounded-full border border-[rgba(139,92,246,0.08)] text-[var(--ag-text-secondary)] bg-[#8B5CF6]/5">
                          {f}
                        </span>
                      ))}
                    </div>
          ...
          <SectionCard padding="lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Brain className="w-5 h-5 text-[var(--ag-cyan)]" />
                <div>
                  <h2 className="text-base font-semibold text-[var(--ag-text-primary)]">Agent can remember things</h2>
            ...
            {memoryEnabled && memoryCount > 0 && (
              <div className="mt-4 pt-4 border-t border-[rgba(139,92,246,0.08)]">
                <p className="text-sm text-[var(--ag-text-secondary)]">
                  Your agent currently has <span className="text-[var(--ag-cyan)] font-semibold">{memoryCount}</span> {memoryCount === 1 ? 'memory' : 'memories'} stored.
                </p>
              </div>
            )}
          </SectionCard>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-[var(--ag-text-secondary)]">View, edit, and manage individual memories</p>
              </div>
            </div>
            <ExternalLink className="w-5 h-5 text-[var(--ag-text-secondary)] group-hover:text-[var(--ag-cyan)] transition-colors" />
          </button>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className={`text-sm font-medium transition-colors duration-200 ${enabled ? 'text-[var(--ag-text-primary)]' : 'text-[var(--ag-text-secondary)]'}`}>
                          {tool.label}
                        </h3>
                        <p className="text-xs text-[var(--ag-text-secondary)]">{tool.description}</p>
                      </div>
                    </div>
                    <Switch
                      checked={enabled}
              ...
              <div className="flex items-center justify-between p-4 min-h-[44px] rounded-xl border border-[rgba(139,92,246,0.08)]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--ag-text-secondary)]">Chat with your agent via Telegram</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  {telegramStatus === 'checking' ? (
                    <span className="text-xs text-[var(--ag-text-secondary)]">Checking...</span>
                  ) : isTelegramConnected ? (
              ...
              <div className="flex items-center justify-between p-4 min-h-[44px] rounded-xl border border-[rgba(139,92,246,0.08)]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--ag-text-secondary)]">Chat via the web dashboard</p>
                  </div>
                </div>
                <span className="flex items-center gap-1.5 text-xs font-medium text-[#ADFF2F]">
