    ...
    <GlassCard accent="violet" className="p-6">
      <div className="space-y-5">
        <TimerRing progress={progress} size={240} strokeWidth={11} accent={near?'amber':'violet'}>
          <div>
            <motion.div className="text-4xl font-mono font-bold tracking-wider" style={{color:'var(--ag-text-primary)',fontVariantNumeric:'tabular-nums'}} animate={{opacity:[1,0.72,1]}} transition={{repeat:Infinity,duration:2,ease:'easeInOut'}}>{remaining!==null?remainStr:elapsedStr}</motion.div>
