        ...
        <button
          ...
          className={`min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-[#8B5CF6]/50 ${
            deviceMode === mode
              ...
              : 'text-[var(--ag-text-muted)] hover:text-[var(--ag-text-primary,#E8E8F0)]'
          }`}
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
        ...
        <TabsContent value="builder" className="mt-6">
          ...
          <SectionCard padding="md" className="mb-6">
            <label className="text-sm text-[#B8C4D4] mb-2 block">Working on:</label>
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg text-sm transition-all duration-200 min-h-[44px] ${
                  !selectedProject
                    ...
                    : 'bg-[rgba(12,12,30,0.6)] text-[#B8C4D4] border border-[rgba(139,92,246,0.08)] hover:border-[rgba(139,92,246,0.15)]'
                }`}
              >
                New Project
              </button>
              {projectsLoading ? (
                <div className="flex items-center gap-2 text-[#B8C4D4] text-sm px-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                  ...
                  <Wand2 className={`w-5 h-5 ${builderMode === 'imagine' ? 'text-[#8B5CF6]' : 'text-[#B8C4D4]'}`} />
                </div>
                <div>
                  <h3 className="text-[#E8E8F0] font-semibold">Imagine & Add</h3>
                  <p className="text-xs text-[#B8C4D4]">Let AI build it for you</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                  builderMode === 'dev' ? 'bg-[#8B5CF6]/20' : 'bg-[#8B5CF6]/10'
                }`}>
                  <Terminal className={`w-5 h-5 ${builderMode === 'dev' ? 'text-[#8B5CF6]' : 'text-[#B8C4D4]'}`} />
                </div>
                <div>
                  <h3 className="text-[#E8E8F0] font-semibold">Feelin&apos; to be a Dev</h3>
                  <p className="text-xs text-[#B8C4D4]">I&apos;ll input on it myself</p>
                </div>
              </div>
              <p className="text-sm text-[#B8C4D4]">
            ...
            <SectionCard padding="lg">
              ...
              <div className="flex gap-3">
                <textarea
                  ...
                  rows={3}
                  className="flex-1 bg-[#06061a] border border-[rgba(139,92,246,0.15)] rounded-xl px-4 py-3 text-[#E8E8F0] placeholder-[#6B7280]/50 resize-none focus:border-[#8B5CF6]/50 outline-none text-sm"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              {!selectedProject && (
                <SectionCard padding="md">
                  ...
                  <input
                    ...
                    className="w-full mt-3 bg-[#06061a] border border-[rgba(139,92,246,0.15)] rounded-xl px-4 py-2.5 text-[#E8E8F0] placeholder-[#6B7280]/50 text-sm focus:border-[#8B5CF6]/50 outline-none min-h-[44px]"
                  />
                </SectionCard>
              )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        spellCheck={false}
                        className="w-full h-48 bg-[#06061a] border border-[rgba(139,92,246,0.08)] rounded-xl px-4 py-3 text-[#E8E8F0] font-mono text-xs resize-none focus:border-[rgba(139,92,246,0.15)] outline-none leading-relaxed"
                  ...
                  <div className="rounded-2xl border border-[rgba(139,92,246,0.15)] overflow-hidden flex flex-col min-h-[500px]">
                    <div className="flex items-center justify-between px-4 py-2 bg-[rgba(12,12,30,0.6)] border-b border-[rgba(139,92,246,0.08)]">
                      <div className="flex items-center gap-3">
                        <span className="text-xs text-[#B8C4D4] font-mono">Preview</span>
                        <DeviceBar />
                      </div>
                      <div className="flex items-center gap-1">
                        <button
                          onClick={() => refreshPreview()}
                          className="min-w-[44px] min-h-[44px] flex items-center justify-center text-[#B8C4D4] hover:text-[#E8E8F0] rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-[#8B5CF6]/50"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) => setDevHtml(e.target.value)}
                      spellCheck={false}
                      className="w-full h-64 bg-[#06061a] border border-[rgba(139,92,246,0.08)] rounded-xl px-4 py-3 text-[#E8E8F0] font-mono text-xs resize-none focus:border-[rgba(139,92,246,0.15)] outline-none leading-relaxed"
                      placeholder="<div>Your HTML here...</div>"
                    />
                  </div>
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 rounded-xl bg-[rgba(12,12,30,0.6)] border border-[rgba(139,92,246,0.15)] text-[#B8C4D4] hover:text-[#E8E8F0] hover:border-[rgba(139,92,246,0.3)] transition-colors text-sm min-h-[44px]"
                >
                ...
                <div className="rounded-2xl border border-[rgba(139,92,246,0.15)] overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-2 bg-[rgba(12,12,30,0.6)] border-b border-[rgba(139,92,246,0.08)]">
                    ...
                    <button
                      ...
                      className="min-w-[44px] min-h-[44px] flex items-center justify-center text-[#B8C4D4] hover:text-[#E8E8F0] focus-visible:ring-2 focus-visible:ring-[#8B5CF6]/50 rounded-lg transition-colors"
              ...
              <SectionCard padding="lg">
                ...
                {assignedAgents.length === 0 ? (
                  <div className="rounded-2xl border border-dashed border-[#8B5CF6]/20 p-10 text-center bg-[#8B5CF6]/[0.02]">
                    ...
                    <p className="text-[#E8E8F0] font-medium text-sm mb-1">No agents assigned yet</p>
                    <p className="text-[#B8C4D4] text-xs max-w-xs mx-auto">Assign agents from your fleet below, or deploy a new one to start automating website tasks.</p>
                  </div>
                ) : (
                        ...
                        >
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-[#B8C4D4] capitalize">Slot {agent.slot} &middot; {agent.personality}</div>
                              </div>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                className="p-1.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg text-[#B8C4D4] hover:text-[#FF6161] hover:bg-[#FF6161]/10 transition-colors focus-visible:ring-2 focus-visible:ring-[#8B5CF6]/50"
                          ...
                          <div className="flex gap-3 mb-3">
                            <div className="flex-1 p-2.5 rounded-lg bg-[#06061a] border border-[#00FF88]/10">
                              <div className="text-xs text-[#B8C4D4]">Completed</div>
                            ...
                            <div className="flex-1 p-2.5 rounded-lg bg-[#06061a] border border-[#FF6161]/10">
                              <div className="text-xs text-[#B8C4D4]">Failed</div>
                          ...
                          {agentTasks.length > 0 ? (
                            <div className="space-y-2">
                              <div className="text-xs text-[#B8C4D4] font-medium">Current Work</div>
                              {agentTasks.slice(0, 2).map(task => (
                                <div key={task.id} className="flex items-center gap-2 p-2 rounded-lg bg-[#06061a] border border-[rgba(139,92,246,0.08)]">
                                  ...
                                  <span className="text-xs capitalize shrink-0"
                                    style={{ color: task.status === 'running' ? '#FFB800' : '#8B5CF6' }}>
                                    {task.status}
                                  </span>
                                </div>
                              ))}
                            ...
                            <div className="flex items-center gap-2 p-2.5 rounded-lg bg-[#06061a] border border-[rgba(139,92,246,0.08)]">
                              <CheckCircle className="w-3.5 h-3.5 text-[#B8C4D4]" />
                              <span className="text-xs text-[#B8C4D4]">No active tasks — ready for work</span>
                            </div>
                          )}

                          <div className="mt-2 text-xs text-[#B8C4D4] flex items-center gap-1">
                ...
                <SectionCard padding="lg">
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 bg-[#06061a] border border-[rgba(139,92,246,0.15)] rounded-xl px-4 py-2.5 text-[#E8E8F0] placeholder-[#6B7280]/50 text-sm focus:border-[#8B5CF6]/50 outline-none min-h-[44px]"
                  ...
                  <p className="text-xs text-[#B8C4D4] mt-2">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs text-[#B8C4D4]">Slot {agent.slot}</div>
                          </div>
                ...
                <div>
                  ...
                  {creatingSlot !== null ? (
                    <SectionCard padding="lg" className="max-w-md">
                      <p className="text-sm text-[#B8C4D4] mb-3">Choose personality for Slot {creatingSlot}</p>
                      <div className="flex gap-2 mb-3">
                        {([
                          { id: 'weebo' as const, emoji: '🤖', label: 'Weebo', color: '#00FF88' },
                          { id: 'jarvis' as const, emoji: '🎩', label: 'Jarvis', color: '#8B5CF6' },
                      ...
                      <input
                        ...
                        className="w-full bg-[#06061a] border border-[rgba(139,92,246,0.15)] rounded-xl px-4 py-2.5 text-[#E8E8F0] placeholder-[#6B7280]/50 text-sm focus:border-[#8B5CF6]/50 outline-none mb-3 min-h-[44px]"
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="px-4 py-2 rounded-xl border border-[rgba(139,92,246,0.15)] text-[#B8C4D4] text-sm hover:text-[#E8E8F0] transition-colors min-h-[44px]"
                        >
                          Cancel
                        </button>
                        <button
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {emptySlots.slice(0, 3).map(slot => (
                        ...
                        >
                          ...
                          <span className="text-sm text-[#B8C4D4] group-hover:text-[#E8E8F0]">Slot {slot}</span>
                        </button>
                      ))}
                    </div>
                  )}
              ...
              {assignedAgents.length > 0 && (
                <div className="pt-4 border-t border-[rgba(139,92,246,0.08)]">
                  <details className="group">
                    <summary className="text-xs text-[#B8C4D4] cursor-pointer hover:text-[#E8E8F0] transition-colors flex items-center gap-1">
                      ...
                      {assignedAgents.map(agent => (
                        <div key={agent.id} className="flex items-center justify-between p-3 rounded-lg bg-[#06061a] border border-[rgba(139,92,246,0.08)]">
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() => toggleAssign(agent.slot)}
                              className="px-3 py-1 rounded-lg text-xs text-[#B8C4D4] border border-[rgba(139,92,246,0.08)] hover:text-[#E8E8F0] hover:border-[rgba(139,92,246,0.15)] transition-colors min-h-[44px] flex items-center"
                            >
                              Unassign
                            </button>
                            {agent.slot !== 1 && (
