 ...
 * Uses PageHeader from @/components/agentin with a live "Cal" badge,
 * streak display, and primary Add Reminder CTA.
 */
				...
				badge={
					...
					>
						<span className="relative flex h-2 w-2">
							<span className="absolute inline-flex h-full w-full rounded-full bg-[var(--ag-emerald)] opacity-75 animate-ping" />
							<span className="relative inline-flex h-2 w-2 rounded-full bg-[var(--ag-emerald)]" />
						</span>
						Cal
					</span>
				}
