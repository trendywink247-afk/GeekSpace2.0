      ...
      <PageHeader
        ...
        badge={
          <span className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full"
            style={{ background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.3)', color: 'var(--ag-emerald)' }}>
        ...
        actions={
          <div className="flex items-center gap-2">
            {streak > 0 && (
              <div className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-xl backdrop-blur-xl"
            ...
            <motion.div whileTap={{ scale: 0.96 }}>
              <Button data-testid="create-reminder-button" onClick={onAdd}
