 ...
 * Clears the requestToolCounts Map so tests don't leak state between test cases.
 *
 * @remarks This is the only module-level state in AnimationTierSelector.ts.
 * isFirstVisit/markVisited use localStorage which tests should mock separately.
 */
