...
import type { CanvasAgent, ParticleBeam, SpeechBubble } from '../../entities/types';
...
import { ROOMS } from '../../entities/roomZones';
 ...
 */
// RenderState interface moved to canvas/types.ts (extracted Phase 0b)
