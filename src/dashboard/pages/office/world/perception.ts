...
import type { RoomZone } from '../entities/roomZones';
import type { SmartObject, InteractionPoint } from '../entities/smartObjects';
import { getRoomAt } from '../entities/roomZones';
import { getObjectsInRoom, SMART_OBJECTS } from '../entities/smartObjects';
import { isPointOccupied } from '../entities/occupancy';
import { isWalkable } from '../systems/navigation/navigation';
