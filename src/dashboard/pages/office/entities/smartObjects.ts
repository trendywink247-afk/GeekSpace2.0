...
export const SMART_OBJECTS: SmartObject[] = [
  // === WORKSPACE ===
  {
    ...
    footprint: [
      ...
      { x: 2, y: 20 }, { x: 6, y: 20 }, // row 20 cols 3-5 are walkable chair tiles
    ],
    interactionPoints: [
      { x: 3, y: 20, facing: 'up', behavior: 'work' },
      { x: 4, y: 20, facing: 'up', behavior: 'work' },
      { x: 5, y: 20, facing: 'up', behavior: 'work' },
  ...
  },
  {
    ...
    footprint: [
      ...
      { x: 8, y: 20 }, { x: 12, y: 20 }, // row 20 cols 9-11 are walkable chair tiles
    ],
    interactionPoints: [
      { x: 9, y: 20, facing: 'up', behavior: 'work' },
      { x: 10, y: 20, facing: 'up', behavior: 'work' },
      { x: 11, y: 20, facing: 'up', behavior: 'work' },
      { x: 7, y: 18, facing: 'left', behavior: 'work' },
