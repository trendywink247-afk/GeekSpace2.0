...
import type { AgentId, InsightCard, SSEEvent } from '../entities/types';
...
import { GoalsTab } from '../sidebar/GoalsTab';
...
export function OfficeHomePage() {
  ...
  useEffect(() => {
    if (!selectedAgentId) { setTaskCount(0); return; } // eslint-disable-line react-hooks/set-state-in-effect
    let cancelled = false;
