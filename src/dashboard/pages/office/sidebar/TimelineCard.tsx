...
import type { TimelineEntry, AgentId } from '../entities/types';
...
> = {
  reply:       { borderColor: '#A78BFA', icon: '💬' },            // overridden by agentColor below
  tool_call:   { borderColor: '#A78BFA', icon: '🔧' },
  ...
  multi_agent: { borderColor: '#A78BFA', icon: '🌐' },
  habit:       { borderColor: '#ADFF2F', icon: '🔥' },
  comm:        { borderColor: '#A78BFA', icon: '💬' },             // overridden by agentColor below
};
