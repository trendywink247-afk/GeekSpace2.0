...
export function TemplateGalleryPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-[#F4F6FF]">Template Gallery</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-[#0B0B10] border border-[#7B61FF]/30 rounded-lg text-[#F4F6FF] placeholder-[#A7ACB8] focus:border-[#7B61FF] outline-none"
          />
        </div>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg whitespace-nowrap transition-colors ${
              selectedCategory === 'all'
                ...
                : 'bg-[#0B0B10] text-[#A7ACB8] hover:text-[#F4F6FF] border border-[#7B61FF]/30'
            }`}
          >
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-[#0B0B10] rounded-xl border border-[#7B61FF]/20">
          <LayoutTemplate className="w-16 h-16 text-[#7B61FF]/40 mx-auto mb-4" />
          <h3 className="text-lg font-medium text-[#F4F6FF] mb-2">No templates found</h3>
          <p className="text-[#A7ACB8]">Try adjusting your search or filters</p>
        </div>
      ) : (
              ...
              <div className="aspect-video bg-gradient-to-br from-[#1a1a2e] to-[#16213e] relative overflow-hidden">
                {template.thumbnail ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Code className="w-16 h-16 text-[#7B61FF]/20" />
                  </div>
                )}
                ...
                {/* Official badge */}
                {template.isOfficial && (
                  <div className="absolute top-3 left-3 px-2 py-1 bg-[#7B61FF]/80 text-white text-xs rounded-full flex items-center gap-1">
                ...
                {/* Category badge */}
                <div className="absolute top-3 right-3 px-2 py-1 bg-[#0B0B10]/80 text-[#A7ACB8] text-xs rounded-full capitalize">
                  {template.category}
                </div>

                <div className="absolute bottom-3 left-3 right-3">
                  <h3 className="text-[#F4F6FF] font-medium text-lg">{template.name}</h3>
                  <div className="flex items-center gap-3 text-xs text-[#A7ACB8] mt-1">
                    <span>{template.cloneCount} uses</span>
                    {template.isOfficial && <span className="text-[#7B61FF]">GeekSpace</span>}
                  </div>
                </div>
              </div>
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-[#7B61FF]/20 text-[#7B61FF] rounded-lg hover:bg-[#7B61FF]/30 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-[#7B61FF] text-white rounded-lg hover:bg-[#7B61FF]/80 transition-colors disabled:opacity-50"
                  >
