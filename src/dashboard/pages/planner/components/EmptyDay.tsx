// ============================================================
// EmptyDay — empty state for a day with no blocks scheduled.
// ============================================================
	...
	return (
		<div className="flex flex-col items-center justify-center py-16 px-6 text-center">
			...
			<p className="text-xs mb-5" style={{ color: "var(--ag-text-muted)" }}>
				{isToday
					? "Drag items from the backlog or tap + to add a block"
					: "No blocks planned for this day"}
			</p>

			{onAddBlock && (
				<PillButton icon={Plus} accent="violet" onClick={onAddBlock}>
					Add a block
				</PillButton>
			)}
		</div>
