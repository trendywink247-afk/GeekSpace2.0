// ============================================================
// BlockComposer — inline quick-add form for creating a new time block.
// Renders inside the timeline slot where user clicked +.
// ============================================================
	...
	return (
		...
		>
			...
			<div className="flex items-center gap-2">
				...
				<Button
					size="sm"
					className="h-9 sm:h-8 px-3 text-xs font-medium min-w-[44px]"
					style={{
						background:
			...
			<div className="flex items-center gap-1.5">
				...
				{DURATION_OPTIONS.map((opt) => (
					<button
						...
						className="px-2.5 py-1.5 sm:px-2 sm:py-1 rounded-full text-[10px] font-medium
              transition-all duration-150 min-h-[44px] sm:min-h-0 select-none"
						style={{
							background:
								duration === opt.value
