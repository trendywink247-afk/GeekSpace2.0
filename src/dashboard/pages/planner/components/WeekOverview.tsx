// ============================================================
// WeekOverview — Mon-Sun grid with hour rows + drag-to-schedule.
// Mobile scrolls horizontally; desktop fits within viewport.
// ============================================================
			...
			<GlassCard accent="indigo" className="overflow-hidden">
				...
				<div className="overflow-x-auto">
					<div style={{ minWidth: 700 }}>
						...
						{/* Hour rows (every 2h for compactness) */}
											...
											>
												{dayBlocks.map((block) => (
													<button
														...
														type="button"
														onClick={() => onSelectDate(d)}
														className="w-full rounded px-1 py-0.5 mb-0.5 text-[10px] truncate text-left
