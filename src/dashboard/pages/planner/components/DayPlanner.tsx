// ============================================================
// DayPlanner — day timeline view (left: backlog, right: time grid).
...
export function DayPlanner({
	...
	return (
		<div className="flex flex-col lg:flex-row gap-4">
			{/* ── Left: backlog + priority list ─────────────────────────────────── */}
			<BlurFade delay={0.15}>
				<div className="w-full lg:w-72 xl:w-80 flex-shrink-0 space-y-4">
					{/* Priority list (today only, if blocks exist) */}
											...
											{!dragItem &&
												...
												quickAddHour !== hour && (
													<button
														...
														className="absolute top-1 right-1 w-11 h-11 sm:w-7 sm:h-7 rounded-lg flex items-center justify-center
