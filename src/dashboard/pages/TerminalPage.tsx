    ...
    <div className="space-y-4 h-[calc(100dvh-220px)] md:h-[calc(100vh-140px)] flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" onClick={clearTerminal} className="border-[#00F0FF]/30 text-[#6B7280]">
          ...
          <button
            ...
            className={`px-3 py-2.5 min-h-[44px] rounded-lg border text-xs transition-colors ${
              cmd.startsWith('ai ')
                ...
                : 'bg-[#0C0C18] border-[#00F0FF]/20 text-[#6B7280] hover:border-[#00F0FF]/50 hover:text-[#E8E8F0]'
            }`}
          >
            {cmd}
          </button>
